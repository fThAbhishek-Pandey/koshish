...
const Top = () => {
  ...
  return (
    ...
    <h1 className='text-green-500 text-center text-3xl font-semibold md:text-4xl lg:text-5xl'>
      Welcome to <span className='text-5xl font-extrabold text-blue10 underline md:text-5xl lg:text-6xl'>KOSHISH</span>
    </h1>
      <h3 className='text-2xl mt-5 text-center text-green-500'>{"<"} {displayText} <span>|</span>{">"}</h3>

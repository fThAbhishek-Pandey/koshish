  ...
  return (
    <div className=" flex flex-col-reverse sm:flex-col-reverse md:flex-row lg:flex-row justify-around ">
       ...
       <div className='text-sm  md:text-lg p-5'>
        ...
        <p>We believe in this shloka, which means: </p>
        <p>Knowledge is a wealth that cannot be stolen by thieves, seized by kings, divided among siblings, or burdened by weight. Unlike material wealth, which decreases when spent, knowledge only grows when shared. Among all forms of wealth, knowledge is the greatest.</p>
       ...
       <div>
        <img className='w-full p-5 rounded-2xl bg-green-100' src={CultureImg} alt="" />
       </div>
       </div>
  )
}
